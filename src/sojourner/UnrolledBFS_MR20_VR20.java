...
if (rc.onTheMap(maploc1068)) {
		...
		if (rc.onTheMap(maploc1025) && mapinfo1025.isPassable() && rc.senseRobotAtLocation(maploc1025) == null) {
		...
		if (rc.onTheMap(maploc1033) && mapinfo1033.isPassable() && rc.senseRobotAtLocation(maploc1033) == null) {
		...
		if (rc.onTheMap(maploc1035) && mapinfo1035.isPassable() && rc.senseRobotAtLocation(maploc1035) == null) {
		...
		if (rc.onTheMap(maploc1043) && mapinfo1043.isPassable() && rc.senseRobotAtLocation(maploc1043) == null) {
		...
		if (rc.onTheMap(maploc1024) && mapinfo1024.isPassable() && rc.senseRobotAtLocation(maploc1024) == null) {
		...
		if (rc.onTheMap(maploc1026) && mapinfo1026.isPassable() && rc.senseRobotAtLocation(maploc1026) == null) {
		...
		if (rc.onTheMap(maploc1042) && mapinfo1042.isPassable() && rc.senseRobotAtLocation(maploc1042) == null) {
		...
		if (rc.onTheMap(maploc1044) && mapinfo1044.isPassable() && rc.senseRobotAtLocation(maploc1044) == null) {
		...
		if (rc.onTheMap(maploc1016) && mapinfo1016.isPassable() && rc.senseRobotAtLocation(maploc1016) == null) {
		...
		if (rc.onTheMap(maploc1032) && mapinfo1032.isPassable() && rc.senseRobotAtLocation(maploc1032) == null) {
		...
		if (rc.onTheMap(maploc1036) && mapinfo1036.isPassable() && rc.senseRobotAtLocation(maploc1036) == null) {
		...
		if (rc.onTheMap(maploc1052) && mapinfo1052.isPassable() && rc.senseRobotAtLocation(maploc1052) == null) {
		...
		if (rc.onTheMap(maploc1015) && mapinfo1015.isPassable() && rc.senseRobotAtLocation(maploc1015) == null) {
		...
		if (rc.onTheMap(maploc1017) && mapinfo1017.isPassable() && rc.senseRobotAtLocation(maploc1017) == null) {
		...
		if (rc.onTheMap(maploc1023) && mapinfo1023.isPassable() && rc.senseRobotAtLocation(maploc1023) == null) {
		...
		if (rc.onTheMap(maploc1027) && mapinfo1027.isPassable() && rc.senseRobotAtLocation(maploc1027) == null) {
		...
		if (rc.onTheMap(maploc1041) && mapinfo1041.isPassable() && rc.senseRobotAtLocation(maploc1041) == null) {
		...
		if (rc.onTheMap(maploc1045) && mapinfo1045.isPassable() && rc.senseRobotAtLocation(maploc1045) == null) {
		...
		if (rc.onTheMap(maploc1051) && mapinfo1051.isPassable() && rc.senseRobotAtLocation(maploc1051) == null) {
		...
		if (rc.onTheMap(maploc1053) && mapinfo1053.isPassable() && rc.senseRobotAtLocation(maploc1053) == null) {
		...
		if (rc.onTheMap(maploc1014) && mapinfo1014.isPassable() && rc.senseRobotAtLocation(maploc1014) == null) {
		...
		if (rc.onTheMap(maploc1018) && mapinfo1018.isPassable() && rc.senseRobotAtLocation(maploc1018) == null) {
		...
		if (rc.onTheMap(maploc1050) && mapinfo1050.isPassable() && rc.senseRobotAtLocation(maploc1050) == null) {
		...
		if (rc.onTheMap(maploc1054) && mapinfo1054.isPassable() && rc.senseRobotAtLocation(maploc1054) == null) {
		...
		if (rc.onTheMap(maploc1008) && mapinfo1008.isPassable() && rc.senseRobotAtLocation(maploc1008) == null) {
		...
		if (rc.onTheMap(maploc1031) && mapinfo1031.isPassable() && rc.senseRobotAtLocation(maploc1031) == null) {
		...
		if (rc.onTheMap(maploc1037) && mapinfo1037.isPassable() && rc.senseRobotAtLocation(maploc1037) == null) {
		...
		if (rc.onTheMap(maploc1060) && mapinfo1060.isPassable() && rc.senseRobotAtLocation(maploc1060) == null) {
		...
		if (rc.onTheMap(maploc1007) && mapinfo1007.isPassable() && rc.senseRobotAtLocation(maploc1007) == null) {
		...
		if (rc.onTheMap(maploc1009) && mapinfo1009.isPassable() && rc.senseRobotAtLocation(maploc1009) == null) {
		...
		if (rc.onTheMap(maploc1022) && mapinfo1022.isPassable() && rc.senseRobotAtLocation(maploc1022) == null) {
		...
		if (rc.onTheMap(maploc1028) && mapinfo1028.isPassable() && rc.senseRobotAtLocation(maploc1028) == null) {
		...
		if (rc.onTheMap(maploc1040) && mapinfo1040.isPassable() && rc.senseRobotAtLocation(maploc1040) == null) {
		...
		if (rc.onTheMap(maploc1046) && mapinfo1046.isPassable() && rc.senseRobotAtLocation(maploc1046) == null) {
		...
		if (rc.onTheMap(maploc1059) && mapinfo1059.isPassable() && rc.senseRobotAtLocation(maploc1059) == null) {
		...
		if (rc.onTheMap(maploc1061) && mapinfo1061.isPassable() && rc.senseRobotAtLocation(maploc1061) == null) {
		...
		if (rc.onTheMap(maploc1006) && mapinfo1006.isPassable() && rc.senseRobotAtLocation(maploc1006) == null) {
		...
		if (rc.onTheMap(maploc1010) && mapinfo1010.isPassable() && rc.senseRobotAtLocation(maploc1010) == null) {
		...
		if (rc.onTheMap(maploc1013) && mapinfo1013.isPassable() && rc.senseRobotAtLocation(maploc1013) == null) {
		...
		if (rc.onTheMap(maploc1019) && mapinfo1019.isPassable() && rc.senseRobotAtLocation(maploc1019) == null) {
		...
		if (rc.onTheMap(maploc1049) && mapinfo1049.isPassable() && rc.senseRobotAtLocation(maploc1049) == null) {
		...
		if (rc.onTheMap(maploc1055) && mapinfo1055.isPassable() && rc.senseRobotAtLocation(maploc1055) == null) {
		...
		if (rc.onTheMap(maploc1058) && mapinfo1058.isPassable() && rc.senseRobotAtLocation(maploc1058) == null) {
		...
		if (rc.onTheMap(maploc1062) && mapinfo1062.isPassable() && rc.senseRobotAtLocation(maploc1062) == null) {
		...
		if (rc.onTheMap(maploc1002) && mapinfo1002.isPassable() && rc.senseRobotAtLocation(maploc1002) == null) {
		...
		if (rc.onTheMap(maploc1030) && mapinfo1030.isPassable() && rc.senseRobotAtLocation(maploc1030) == null) {
		...
		if (rc.onTheMap(maploc1038) && mapinfo1038.isPassable() && rc.senseRobotAtLocation(maploc1038) == null) {
		...
		if (rc.onTheMap(maploc1066) && mapinfo1066.isPassable() && rc.senseRobotAtLocation(maploc1066) == null) {
		...
		if (rc.onTheMap(maploc1001) && mapinfo1001.isPassable() && rc.senseRobotAtLocation(maploc1001) == null) {
		...
		if (rc.onTheMap(maploc1003) && mapinfo1003.isPassable() && rc.senseRobotAtLocation(maploc1003) == null) {
		...
		if (rc.onTheMap(maploc1021) && mapinfo1021.isPassable() && rc.senseRobotAtLocation(maploc1021) == null) {
		...
		if (rc.onTheMap(maploc1029) && mapinfo1029.isPassable() && rc.senseRobotAtLocation(maploc1029) == null) {
		...
		if (rc.onTheMap(maploc1039) && mapinfo1039.isPassable() && rc.senseRobotAtLocation(maploc1039) == null) {
		...
		if (rc.onTheMap(maploc1047) && mapinfo1047.isPassable() && rc.senseRobotAtLocation(maploc1047) == null) {
		...
		if (rc.onTheMap(maploc1065) && mapinfo1065.isPassable() && rc.senseRobotAtLocation(maploc1065) == null) {
		...
		if (rc.onTheMap(maploc1067) && mapinfo1067.isPassable() && rc.senseRobotAtLocation(maploc1067) == null) {
		...
		if (rc.onTheMap(maploc1005) && mapinfo1005.isPassable() && rc.senseRobotAtLocation(maploc1005) == null) {
		...
		if (rc.onTheMap(maploc1011) && mapinfo1011.isPassable() && rc.senseRobotAtLocation(maploc1011) == null) {
		...
		if (rc.onTheMap(maploc1057) && mapinfo1057.isPassable() && rc.senseRobotAtLocation(maploc1057) == null) {
		...
		if (rc.onTheMap(maploc1063) && mapinfo1063.isPassable() && rc.senseRobotAtLocation(maploc1063) == null) {
		...
		case -4:
			switch (dy) {
			case 2: if (rc.onTheMap(maploc1012)) return initialDirection1012;
			case 1: if (rc.onTheMap(maploc1021)) return initialDirection1021;
			case 0: if (rc.onTheMap(maploc1030)) return initialDirection1030;
			case -1: if (rc.onTheMap(maploc1039)) return initialDirection1039;
			case -2: if (rc.onTheMap(maploc1048)) return initialDirection1048;
			}
			break;
		case -3:
			switch (dy) {
			case 3: if (rc.onTheMap(maploc1005)) return initialDirection1005;
			case 2: if (rc.onTheMap(maploc1013)) return initialDirection1013;
			case 1: if (rc.onTheMap(maploc1022)) return initialDirection1022;
			case 0: if (rc.onTheMap(maploc1031)) return initialDirection1031;
			case -1: if (rc.onTheMap(maploc1040)) return initialDirection1040;
			case -2: if (rc.onTheMap(maploc1049)) return initialDirection1049;
			case -3: if (rc.onTheMap(maploc1057)) return initialDirection1057;
			}
			break;
		case -2:
			switch (dy) {
			case 4: if (rc.onTheMap(maploc1000)) return initialDirection1000;
			case 3: if (rc.onTheMap(maploc1006)) return initialDirection1006;
			case 2: if (rc.onTheMap(maploc1014)) return initialDirection1014;
			case 1: if (rc.onTheMap(maploc1023)) return initialDirection1023;
			case 0: if (rc.onTheMap(maploc1032)) return initialDirection1032;
			case -1: if (rc.onTheMap(maploc1041)) return initialDirection1041;
			case -2: if (rc.onTheMap(maploc1050)) return initialDirection1050;
			case -3: if (rc.onTheMap(maploc1058)) return initialDirection1058;
			case -4: if (rc.onTheMap(maploc1064)) return initialDirection1064;
			}
			break;
		case -1:
			switch (dy) {
			case 4: if (rc.onTheMap(maploc1001)) return initialDirection1001;
			case 3: if (rc.onTheMap(maploc1007)) return initialDirection1007;
			case 2: if (rc.onTheMap(maploc1015)) return initialDirection1015;
			case 1: if (rc.onTheMap(maploc1024)) return initialDirection1024;
			case 0: if (rc.onTheMap(maploc1033)) return initialDirection1033;
			case -1: if (rc.onTheMap(maploc1042)) return initialDirection1042;
			case -2: if (rc.onTheMap(maploc1051)) return initialDirection1051;
			case -3: if (rc.onTheMap(maploc1059)) return initialDirection1059;
			case -4: if (rc.onTheMap(maploc1065)) return initialDirection1065;
			}
			break;
		case 0:
			switch (dy) {
			case 4: if (rc.onTheMap(maploc1002)) return initialDirection1002;
			case 3: if (rc.onTheMap(maploc1008)) return initialDirection1008;
			case 2: if (rc.onTheMap(maploc1016)) return initialDirection1016;
			case 1: if (rc.onTheMap(maploc1025)) return initialDirection1025;
			case 0: if (rc.onTheMap(maploc1034)) return initialDirection1034;
			case -1: if (rc.onTheMap(maploc1043)) return initialDirection1043;
			case -2: if (rc.onTheMap(maploc1052)) return initialDirection1052;
			case -3: if (rc.onTheMap(maploc1060)) return initialDirection1060;
			case -4: if (rc.onTheMap(maploc1066)) return initialDirection1066;
			}
			break;
		case 1:
			switch (dy) {
			case 4: if (rc.onTheMap(maploc1003)) return initialDirection1003;
			case 3: if (rc.onTheMap(maploc1009)) return initialDirection1009;
			case 2: if (rc.onTheMap(maploc1017)) return initialDirection1017;
			case 1: if (rc.onTheMap(maploc1026)) return initialDirection1026;
			case 0: if (rc.onTheMap(maploc1035)) return initialDirection1035;
			case -1: if (rc.onTheMap(maploc1044)) return initialDirection1044;
			case -2: if (rc.onTheMap(maploc1053)) return initialDirection1053;
			case -3: if (rc.onTheMap(maploc1061)) return initialDirection1061;
			case -4: if (rc.onTheMap(maploc1067)) return initialDirection1067;
			}
			break;
		case 2:
			switch (dy) {
			case 4: if (rc.onTheMap(maploc1004)) return initialDirection1004;
			case 3: if (rc.onTheMap(maploc1010)) return initialDirection1010;
			case 2: if (rc.onTheMap(maploc1018)) return initialDirection1018;
			case 1: if (rc.onTheMap(maploc1027)) return initialDirection1027;
			case 0: if (rc.onTheMap(maploc1036)) return initialDirection1036;
			case -1: if (rc.onTheMap(maploc1045)) return initialDirection1045;
			case -2: if (rc.onTheMap(maploc1054)) return initialDirection1054;
			case -3: if (rc.onTheMap(maploc1062)) return initialDirection1062;
			case -4: if (rc.onTheMap(maploc1068)) return initialDirection1068;
			}
			break;
		case 3:
			switch (dy) {
			case 3: if (rc.onTheMap(maploc1011)) return initialDirection1011;
			case 2: if (rc.onTheMap(maploc1019)) return initialDirection1019;
			case 1: if (rc.onTheMap(maploc1028)) return initialDirection1028;
			case 0: if (rc.onTheMap(maploc1037)) return initialDirection1037;
			case -1: if (rc.onTheMap(maploc1046)) return initialDirection1046;
			case -2: if (rc.onTheMap(maploc1055)) return initialDirection1055;
			case -3: if (rc.onTheMap(maploc1063)) return initialDirection1063;
			}
			break;
		case 4:
			switch (dy) {
			case 2: if (rc.onTheMap(maploc1020)) return initialDirection1020;
			case 1: if (rc.onTheMap(maploc1029)) return initialDirection1029;
			case 0: if (rc.onTheMap(maploc1038)) return initialDirection1038;
			case -1: if (rc.onTheMap(maploc1047)) return initialDirection1047;
			case -2: if (rc.onTheMap(maploc1056)) return initialDirection1056;
			}
			break;
		}
		...
		if (rc.onTheMap(maploc1068) && mapinfo1068.isPassable() && rc.senseRobotAtLocation(maploc1068) == null) {
		...
		if (rc.onTheMap(maploc1064) && mapinfo1064.isPassable() && rc.senseRobotAtLocation(maploc1064) == null) {
		...
		if (rc.onTheMap(maploc1056) && mapinfo1056.isPassable() && rc.senseRobotAtLocation(maploc1056) == null) {
		...
		if (rc.onTheMap(maploc1048) && mapinfo1048.isPassable() && rc.senseRobotAtLocation(maploc1048) == null) {
		...
		if (rc.onTheMap(maploc1020) && mapinfo1020.isPassable() && rc.senseRobotAtLocation(maploc1020) == null) {
		...
		if (rc.onTheMap(maploc1012) && mapinfo1012.isPassable() && rc.senseRobotAtLocation(maploc1012) == null) {
		...
		if (rc.onTheMap(maploc1004) && mapinfo1004.isPassable() && rc.senseRobotAtLocation(maploc1004) == null) {
		...
		if (rc.onTheMap(maploc1000) && mapinfo1000.isPassable() && rc.senseRobotAtLocation(maploc1000) == null) {
		...
		if (rc.onTheMap(maploc1000) && mapinfo1000.isPassable() && rc.senseRobotAtLocation(maploc1000) == null && accessibilityFactor1000 + potentialFactor1000 < bestValue) {
			bestValue = accessibilityFactor1000 + potentialFactor1000;
			bestDirection = initialDirection1000;
			bestLocation = maploc1000;
		}
		if (rc.onTheMap(maploc1001) && mapinfo1001.isPassable() && rc.senseRobotAtLocation(maploc1001) == null && accessibilityFactor1001 + potentialFactor1001 < bestValue) {
			bestValue = accessibilityFactor1001 + potentialFactor1001;
			bestDirection = initialDirection1001;
			bestLocation = maploc1001;
		}
		if (rc.onTheMap(maploc1002) && mapinfo1002.isPassable() && rc.senseRobotAtLocation(maploc1002) == null && accessibilityFactor1002 + potentialFactor1002 < bestValue) {
			bestValue = accessibilityFactor1002 + potentialFactor1002;
			bestDirection = initialDirection1002;
			bestLocation = maploc1002;
		}
		if (rc.onTheMap(maploc1003) && mapinfo1003.isPassable() && rc.senseRobotAtLocation(maploc1003) == null && accessibilityFactor1003 + potentialFactor1003 < bestValue) {
			bestValue = accessibilityFactor1003 + potentialFactor1003;
			bestDirection = initialDirection1003;
			bestLocation = maploc1003;
		}
		if (rc.onTheMap(maploc1004) && mapinfo1004.isPassable() && rc.senseRobotAtLocation(maploc1004) == null && accessibilityFactor1004 + potentialFactor1004 < bestValue) {
			bestValue = accessibilityFactor1004 + potentialFactor1004;
			bestDirection = initialDirection1004;
			bestLocation = maploc1004;
		}
		if (rc.onTheMap(maploc1005) && mapinfo1005.isPassable() && rc.senseRobotAtLocation(maploc1005) == null && accessibilityFactor1005 + potentialFactor1005 < bestValue) {
			bestValue = accessibilityFactor1005 + potentialFactor1005;
			bestDirection = initialDirection1005;
			bestLocation = maploc1005;
		}
		if (rc.onTheMap(maploc1006) && mapinfo1006.isPassable() && rc.senseRobotAtLocation(maploc1006) == null && accessibilityFactor1006 + potentialFactor1006 < bestValue) {
			bestValue = accessibilityFactor1006 + potentialFactor1006;
			bestDirection = initialDirection1006;
			bestLocation = maploc1006;
		}
		if (rc.onTheMap(maploc1007) && mapinfo1007.isPassable() && rc.senseRobotAtLocation(maploc1007) == null && accessibilityFactor1007 + potentialFactor1007 < bestValue) {
			bestValue = accessibilityFactor1007 + potentialFactor1007;
			bestDirection = initialDirection1007;
			bestLocation = maploc1007;
		}
		if (rc.onTheMap(maploc1008) && mapinfo1008.isPassable() && rc.senseRobotAtLocation(maploc1008) == null && accessibilityFactor1008 + potentialFactor1008 < bestValue) {
			bestValue = accessibilityFactor1008 + potentialFactor1008;
			bestDirection = initialDirection1008;
			bestLocation = maploc1008;
		}
		if (rc.onTheMap(maploc1009) && mapinfo1009.isPassable() && rc.senseRobotAtLocation(maploc1009) == null && accessibilityFactor1009 + potentialFactor1009 < bestValue) {
			bestValue = accessibilityFactor1009 + potentialFactor1009;
			bestDirection = initialDirection1009;
			bestLocation = maploc1009;
		}
		if (rc.onTheMap(maploc1010) && mapinfo1010.isPassable() && rc.senseRobotAtLocation(maploc1010) == null && accessibilityFactor1010 + potentialFactor1010 < bestValue) {
			bestValue = accessibilityFactor1010 + potentialFactor1010;
			bestDirection = initialDirection1010;
			bestLocation = maploc1010;
		}
		if (rc.onTheMap(maploc1011) && mapinfo1011.isPassable() && rc.senseRobotAtLocation(maploc1011) == null && accessibilityFactor1011 + potentialFactor1011 < bestValue) {
			bestValue = accessibilityFactor1011 + potentialFactor1011;
			bestDirection = initialDirection1011;
			bestLocation = maploc1011;
		}
		if (rc.onTheMap(maploc1012) && mapinfo1012.isPassable() && rc.senseRobotAtLocation(maploc1012) == null && accessibilityFactor1012 + potentialFactor1012 < bestValue) {
			bestValue = accessibilityFactor1012 + potentialFactor1012;
			bestDirection = initialDirection1012;
			bestLocation = maploc1012;
		}
		if (rc.onTheMap(maploc1013) && mapinfo1013.isPassable() && rc.senseRobotAtLocation(maploc1013) == null && accessibilityFactor1013 + potentialFactor1013 < bestValue) {
			bestValue = accessibilityFactor1013 + potentialFactor1013;
			bestDirection = initialDirection1013;
			bestLocation = maploc1013;
		}
		if (rc.onTheMap(maploc1014) && mapinfo1014.isPassable() && rc.senseRobotAtLocation(maploc1014) == null && accessibilityFactor1014 + potentialFactor1014 < bestValue) {
			bestValue = accessibilityFactor1014 + potentialFactor1014;
			bestDirection = initialDirection1014;
			bestLocation = maploc1014;
		}
		if (rc.onTheMap(maploc1015) && mapinfo1015.isPassable() && rc.senseRobotAtLocation(maploc1015) == null && accessibilityFactor1015 + potentialFactor1015 < bestValue) {
			bestValue = accessibilityFactor1015 + potentialFactor1015;
			bestDirection = initialDirection1015;
			bestLocation = maploc1015;
		}
		if (rc.onTheMap(maploc1016) && mapinfo1016.isPassable() && rc.senseRobotAtLocation(maploc1016) == null && accessibilityFactor1016 + potentialFactor1016 < bestValue) {
			bestValue = accessibilityFactor1016 + potentialFactor1016;
			bestDirection = initialDirection1016;
			bestLocation = maploc1016;
		}
		if (rc.onTheMap(maploc1017) && mapinfo1017.isPassable() && rc.senseRobotAtLocation(maploc1017) == null && accessibilityFactor1017 + potentialFactor1017 < bestValue) {
			bestValue = accessibilityFactor1017 + potentialFactor1017;
			bestDirection = initialDirection1017;
			bestLocation = maploc1017;
		}
		if (rc.onTheMap(maploc1018) && mapinfo1018.isPassable() && rc.senseRobotAtLocation(maploc1018) == null && accessibilityFactor1018 + potentialFactor1018 < bestValue) {
			bestValue = accessibilityFactor1018 + potentialFactor1018;
			bestDirection = initialDirection1018;
			bestLocation = maploc1018;
		}
		if (rc.onTheMap(maploc1019) && mapinfo1019.isPassable() && rc.senseRobotAtLocation(maploc1019) == null && accessibilityFactor1019 + potentialFactor1019 < bestValue) {
			bestValue = accessibilityFactor1019 + potentialFactor1019;
			bestDirection = initialDirection1019;
			bestLocation = maploc1019;
		}
		if (rc.onTheMap(maploc1020) && mapinfo1020.isPassable() && rc.senseRobotAtLocation(maploc1020) == null && accessibilityFactor1020 + potentialFactor1020 < bestValue) {
			bestValue = accessibilityFactor1020 + potentialFactor1020;
			bestDirection = initialDirection1020;
			bestLocation = maploc1020;
		}
		if (rc.onTheMap(maploc1021) && mapinfo1021.isPassable() && rc.senseRobotAtLocation(maploc1021) == null && accessibilityFactor1021 + potentialFactor1021 < bestValue) {
			bestValue = accessibilityFactor1021 + potentialFactor1021;
			bestDirection = initialDirection1021;
			bestLocation = maploc1021;
		}
		if (rc.onTheMap(maploc1022) && mapinfo1022.isPassable() && rc.senseRobotAtLocation(maploc1022) == null && accessibilityFactor1022 + potentialFactor1022 < bestValue) {
			bestValue = accessibilityFactor1022 + potentialFactor1022;
			bestDirection = initialDirection1022;
			bestLocation = maploc1022;
		}
		if (rc.onTheMap(maploc1023) && mapinfo1023.isPassable() && rc.senseRobotAtLocation(maploc1023) == null && accessibilityFactor1023 + potentialFactor1023 < bestValue) {
			bestValue = accessibilityFactor1023 + potentialFactor1023;
			bestDirection = initialDirection1023;
			bestLocation = maploc1023;
		}
		if (rc.onTheMap(maploc1024) && mapinfo1024.isPassable() && rc.senseRobotAtLocation(maploc1024) == null && accessibilityFactor1024 + potentialFactor1024 < bestValue) {
			bestValue = accessibilityFactor1024 + potentialFactor1024;
			bestDirection = initialDirection1024;
			bestLocation = maploc1024;
		}
		if (rc.onTheMap(maploc1025) && mapinfo1025.isPassable() && rc.senseRobotAtLocation(maploc1025) == null && accessibilityFactor1025 + potentialFactor1025 < bestValue) {
			bestValue = accessibilityFactor1025 + potentialFactor1025;
			bestDirection = initialDirection1025;
			bestLocation = maploc1025;
		}
		if (rc.onTheMap(maploc1026) && mapinfo1026.isPassable() && rc.senseRobotAtLocation(maploc1026) == null && accessibilityFactor1026 + potentialFactor1026 < bestValue) {
			bestValue = accessibilityFactor1026 + potentialFactor1026;
			bestDirection = initialDirection1026;
			bestLocation = maploc1026;
		}
		if (rc.onTheMap(maploc1027) && mapinfo1027.isPassable() && rc.senseRobotAtLocation(maploc1027) == null && accessibilityFactor1027 + potentialFactor1027 < bestValue) {
			bestValue = accessibilityFactor1027 + potentialFactor1027;
			bestDirection = initialDirection1027;
			bestLocation = maploc1027;
		}
		if (rc.onTheMap(maploc1028) && mapinfo1028.isPassable() && rc.senseRobotAtLocation(maploc1028) == null && accessibilityFactor1028 + potentialFactor1028 < bestValue) {
			bestValue = accessibilityFactor1028 + potentialFactor1028;
			bestDirection = initialDirection1028;
			bestLocation = maploc1028;
		}
		if (rc.onTheMap(maploc1029) && mapinfo1029.isPassable() && rc.senseRobotAtLocation(maploc1029) == null && accessibilityFactor1029 + potentialFactor1029 < bestValue) {
			bestValue = accessibilityFactor1029 + potentialFactor1029;
			bestDirection = initialDirection1029;
			bestLocation = maploc1029;
		}
		if (rc.onTheMap(maploc1030) && mapinfo1030.isPassable() && rc.senseRobotAtLocation(maploc1030) == null && accessibilityFactor1030 + potentialFactor1030 < bestValue) {
			bestValue = accessibilityFactor1030 + potentialFactor1030;
			bestDirection = initialDirection1030;
			bestLocation = maploc1030;
		}
		if (rc.onTheMap(maploc1031) && mapinfo1031.isPassable() && rc.senseRobotAtLocation(maploc1031) == null && accessibilityFactor1031 + potentialFactor1031 < bestValue) {
			bestValue = accessibilityFactor1031 + potentialFactor1031;
			bestDirection = initialDirection1031;
			bestLocation = maploc1031;
		}
		if (rc.onTheMap(maploc1032) && mapinfo1032.isPassable() && rc.senseRobotAtLocation(maploc1032) == null && accessibilityFactor1032 + potentialFactor1032 < bestValue) {
			bestValue = accessibilityFactor1032 + potentialFactor1032;
			bestDirection = initialDirection1032;
			bestLocation = maploc1032;
		}
		if (rc.onTheMap(maploc1033) && mapinfo1033.isPassable() && rc.senseRobotAtLocation(maploc1033) == null && accessibilityFactor1033 + potentialFactor1033 < bestValue) {
			bestValue = accessibilityFactor1033 + potentialFactor1033;
			bestDirection = initialDirection1033;
			bestLocation = maploc1033;
		}
		if (rc.onTheMap(maploc1034) && mapinfo1034.isPassable() && rc.senseRobotAtLocation(maploc1034) == null && accessibilityFactor1034 + potentialFactor1034 < bestValue) {
			bestValue = accessibilityFactor1034 + potentialFactor1034;
			bestDirection = initialDirection1034;
			bestLocation = maploc1034;
		}
		if (rc.onTheMap(maploc1035) && mapinfo1035.isPassable() && rc.senseRobotAtLocation(maploc1035) == null && accessibilityFactor1035 + potentialFactor1035 < bestValue) {
			bestValue = accessibilityFactor1035 + potentialFactor1035;
			bestDirection = initialDirection1035;
			bestLocation = maploc1035;
		}
		if (rc.onTheMap(maploc1036) && mapinfo1036.isPassable() && rc.senseRobotAtLocation(maploc1036) == null && accessibilityFactor1036 + potentialFactor1036 < bestValue) {
			bestValue = accessibilityFactor1036 + potentialFactor1036;
			bestDirection = initialDirection1036;
			bestLocation = maploc1036;
		}
		if (rc.onTheMap(maploc1037) && mapinfo1037.isPassable() && rc.senseRobotAtLocation(maploc1037) == null && accessibilityFactor1037 + potentialFactor1037 < bestValue) {
			bestValue = accessibilityFactor1037 + potentialFactor1037;
			bestDirection = initialDirection1037;
			bestLocation = maploc1037;
		}
		if (rc.onTheMap(maploc1038) && mapinfo1038.isPassable() && rc.senseRobotAtLocation(maploc1038) == null && accessibilityFactor1038 + potentialFactor1038 < bestValue) {
			bestValue = accessibilityFactor1038 + potentialFactor1038;
			bestDirection = initialDirection1038;
			bestLocation = maploc1038;
		}
		if (rc.onTheMap(maploc1039) && mapinfo1039.isPassable() && rc.senseRobotAtLocation(maploc1039) == null && accessibilityFactor1039 + potentialFactor1039 < bestValue) {
			bestValue = accessibilityFactor1039 + potentialFactor1039;
			bestDirection = initialDirection1039;
			bestLocation = maploc1039;
		}
		if (rc.onTheMap(maploc1040) && mapinfo1040.isPassable() && rc.senseRobotAtLocation(maploc1040) == null && accessibilityFactor1040 + potentialFactor1040 < bestValue) {
			bestValue = accessibilityFactor1040 + potentialFactor1040;
			bestDirection = initialDirection1040;
			bestLocation = maploc1040;
		}
		if (rc.onTheMap(maploc1041) && mapinfo1041.isPassable() && rc.senseRobotAtLocation(maploc1041) == null && accessibilityFactor1041 + potentialFactor1041 < bestValue) {
			bestValue = accessibilityFactor1041 + potentialFactor1041;
			bestDirection = initialDirection1041;
			bestLocation = maploc1041;
		}
		if (rc.onTheMap(maploc1042) && mapinfo1042.isPassable() && rc.senseRobotAtLocation(maploc1042) == null && accessibilityFactor1042 + potentialFactor1042 < bestValue) {
			bestValue = accessibilityFactor1042 + potentialFactor1042;
			bestDirection = initialDirection1042;
			bestLocation = maploc1042;
		}
		if (rc.onTheMap(maploc1043) && mapinfo1043.isPassable() && rc.senseRobotAtLocation(maploc1043) == null && accessibilityFactor1043 + potentialFactor1043 < bestValue) {
			bestValue = accessibilityFactor1043 + potentialFactor1043;
			bestDirection = initialDirection1043;
			bestLocation = maploc1043;
		}
		if (rc.onTheMap(maploc1044) && mapinfo1044.isPassable() && rc.senseRobotAtLocation(maploc1044) == null && accessibilityFactor1044 + potentialFactor1044 < bestValue) {
			bestValue = accessibilityFactor1044 + potentialFactor1044;
			bestDirection = initialDirection1044;
			bestLocation = maploc1044;
		}
		if (rc.onTheMap(maploc1045) && mapinfo1045.isPassable() && rc.senseRobotAtLocation(maploc1045) == null && accessibilityFactor1045 + potentialFactor1045 < bestValue) {
			bestValue = accessibilityFactor1045 + potentialFactor1045;
			bestDirection = initialDirection1045;
			bestLocation = maploc1045;
		}
		if (rc.onTheMap(maploc1046) && mapinfo1046.isPassable() && rc.senseRobotAtLocation(maploc1046) == null && accessibilityFactor1046 + potentialFactor1046 < bestValue) {
			bestValue = accessibilityFactor1046 + potentialFactor1046;
			bestDirection = initialDirection1046;
			bestLocation = maploc1046;
		}
		if (rc.onTheMap(maploc1047) && mapinfo1047.isPassable() && rc.senseRobotAtLocation(maploc1047) == null && accessibilityFactor1047 + potentialFactor1047 < bestValue) {
			bestValue = accessibilityFactor1047 + potentialFactor1047;
			bestDirection = initialDirection1047;
			bestLocation = maploc1047;
		}
		if (rc.onTheMap(maploc1048) && mapinfo1048.isPassable() && rc.senseRobotAtLocation(maploc1048) == null && accessibilityFactor1048 + potentialFactor1048 < bestValue) {
			bestValue = accessibilityFactor1048 + potentialFactor1048;
			bestDirection = initialDirection1048;
			bestLocation = maploc1048;
		}
		if (rc.onTheMap(maploc1049) && mapinfo1049.isPassable() && rc.senseRobotAtLocation(maploc1049) == null && accessibilityFactor1049 + potentialFactor1049 < bestValue) {
			bestValue = accessibilityFactor1049 + potentialFactor1049;
			bestDirection = initialDirection1049;
			bestLocation = maploc1049;
		}
		if (rc.onTheMap(maploc1050) && mapinfo1050.isPassable() && rc.senseRobotAtLocation(maploc1050) == null && accessibilityFactor1050 + potentialFactor1050 < bestValue) {
			bestValue = accessibilityFactor1050 + potentialFactor1050;
			bestDirection = initialDirection1050;
			bestLocation = maploc1050;
		}
		if (rc.onTheMap(maploc1051) && mapinfo1051.isPassable() && rc.senseRobotAtLocation(maploc1051) == null && accessibilityFactor1051 + potentialFactor1051 < bestValue) {
			bestValue = accessibilityFactor1051 + potentialFactor1051;
			bestDirection = initialDirection1051;
			bestLocation = maploc1051;
		}
		if (rc.onTheMap(maploc1052) && mapinfo1052.isPassable() && rc.senseRobotAtLocation(maploc1052) == null && accessibilityFactor1052 + potentialFactor1052 < bestValue) {
			bestValue = accessibilityFactor1052 + potentialFactor1052;
			bestDirection = initialDirection1052;
			bestLocation = maploc1052;
		}
		if (rc.onTheMap(maploc1053) && mapinfo1053.isPassable() && rc.senseRobotAtLocation(maploc1053) == null && accessibilityFactor1053 + potentialFactor1053 < bestValue) {
			bestValue = accessibilityFactor1053 + potentialFactor1053;
			bestDirection = initialDirection1053;
			bestLocation = maploc1053;
		}
		if (rc.onTheMap(maploc1054) && mapinfo1054.isPassable() && rc.senseRobotAtLocation(maploc1054) == null && accessibilityFactor1054 + potentialFactor1054 < bestValue) {
			bestValue = accessibilityFactor1054 + potentialFactor1054;
			bestDirection = initialDirection1054;
			bestLocation = maploc1054;
		}
		if (rc.onTheMap(maploc1055) && mapinfo1055.isPassable() && rc.senseRobotAtLocation(maploc1055) == null && accessibilityFactor1055 + potentialFactor1055 < bestValue) {
			bestValue = accessibilityFactor1055 + potentialFactor1055;
			bestDirection = initialDirection1055;
			bestLocation = maploc1055;
		}
		if (rc.onTheMap(maploc1056) && mapinfo1056.isPassable() && rc.senseRobotAtLocation(maploc1056) == null && accessibilityFactor1056 + potentialFactor1056 < bestValue) {
			bestValue = accessibilityFactor1056 + potentialFactor1056;
			bestDirection = initialDirection1056;
			bestLocation = maploc1056;
		}
		if (rc.onTheMap(maploc1057) && mapinfo1057.isPassable() && rc.senseRobotAtLocation(maploc1057) == null && accessibilityFactor1057 + potentialFactor1057 < bestValue) {
			bestValue = accessibilityFactor1057 + potentialFactor1057;
			bestDirection = initialDirection1057;
			bestLocation = maploc1057;
		}
		if (rc.onTheMap(maploc1058) && mapinfo1058.isPassable() && rc.senseRobotAtLocation(maploc1058) == null && accessibilityFactor1058 + potentialFactor1058 < bestValue) {
			bestValue = accessibilityFactor1058 + potentialFactor1058;
			bestDirection = initialDirection1058;
			bestLocation = maploc1058;
		}
		if (rc.onTheMap(maploc1059) && mapinfo1059.isPassable() && rc.senseRobotAtLocation(maploc1059) == null && accessibilityFactor1059 + potentialFactor1059 < bestValue) {
			bestValue = accessibilityFactor1059 + potentialFactor1059;
			bestDirection = initialDirection1059;
			bestLocation = maploc1059;
		}
		if (rc.onTheMap(maploc1060) && mapinfo1060.isPassable() && rc.senseRobotAtLocation(maploc1060) == null && accessibilityFactor1060 + potentialFactor1060 < bestValue) {
			bestValue = accessibilityFactor1060 + potentialFactor1060;
			bestDirection = initialDirection1060;
			bestLocation = maploc1060;
		}
		if (rc.onTheMap(maploc1061) && mapinfo1061.isPassable() && rc.senseRobotAtLocation(maploc1061) == null && accessibilityFactor1061 + potentialFactor1061 < bestValue) {
			bestValue = accessibilityFactor1061 + potentialFactor1061;
			bestDirection = initialDirection1061;
			bestLocation = maploc1061;
		}
		if (rc.onTheMap(maploc1062) && mapinfo1062.isPassable() && rc.senseRobotAtLocation(maploc1062) == null && accessibilityFactor1062 + potentialFactor1062 < bestValue) {
			bestValue = accessibilityFactor1062 + potentialFactor1062;
			bestDirection = initialDirection1062;
			bestLocation = maploc1062;
		}
		if (rc.onTheMap(maploc1063) && mapinfo1063.isPassable() && rc.senseRobotAtLocation(maploc1063) == null && accessibilityFactor1063 + potentialFactor1063 < bestValue) {
			bestValue = accessibilityFactor1063 + potentialFactor1063;
			bestDirection = initialDirection1063;
			bestLocation = maploc1063;
		}
		if (rc.onTheMap(maploc1064) && mapinfo1064.isPassable() && rc.senseRobotAtLocation(maploc1064) == null && accessibilityFactor1064 + potentialFactor1064 < bestValue) {
			bestValue = accessibilityFactor1064 + potentialFactor1064;
			bestDirection = initialDirection1064;
			bestLocation = maploc1064;
		}
		if (rc.onTheMap(maploc1065) && mapinfo1065.isPassable() && rc.senseRobotAtLocation(maploc1065) == null && accessibilityFactor1065 + potentialFactor1065 < bestValue) {
			bestValue = accessibilityFactor1065 + potentialFactor1065;
			bestDirection = initialDirection1065;
			bestLocation = maploc1065;
		}
		if (rc.onTheMap(maploc1066) && mapinfo1066.isPassable() && rc.senseRobotAtLocation(maploc1066) == null && accessibilityFactor1066 + potentialFactor1066 < bestValue) {
			bestValue = accessibilityFactor1066 + potentialFactor1066;
			bestDirection = initialDirection1066;
			bestLocation = maploc1066;
		}
		if (rc.onTheMap(maploc1067) && mapinfo1067.isPassable() && rc.senseRobotAtLocation(maploc1067) == null && accessibilityFactor1067 + potentialFactor1067 < bestValue) {
			bestValue = accessibilityFactor1067 + potentialFactor1067;
			bestDirection = initialDirection1067;
			bestLocation = maploc1067;
		}
		if (rc.onTheMap(maploc1068) && mapinfo1068.isPassable() && rc.senseRobotAtLocation(maploc1068) == null && accessibilityFactor1068 + potentialFactor1068 < bestValue) {
			bestValue = accessibilityFactor1068 + potentialFactor1068;
			bestDirection = initialDirection1068;
			bestLocation = maploc1068;
		}
